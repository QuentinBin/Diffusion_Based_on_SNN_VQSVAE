...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str,default='WATER')
    parser.add_argument('--seed',type=int,default=42)
    parser.add_argument('--model',type=str,default='snn-vq-vae')
    parser.add_argument('--data_path',type=str,default='./water_data/trainA')  # './data/pengbin/SNN-VAE-DMSVDD/datasets/Datasets')
